...
public class Bank {
    ...
    public boolean listCustomers(String branchName,boolean showTransactions){
        ...
        if(branch!=null){
            ...
            for(int i=0;i<branchCustomers.size();i++){ //gets a list of all the customers in a particular branch
                Customer branchCustomer=branchCustomers.get(i);
                System.out.println("Customer: "+branchCustomer.getName()+"["+(i+1)+"]");
                if(showTransactions){//Shows all the transactions for a particular customer;
